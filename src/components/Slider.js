...
class MySlider extends React.Component {
  ...
  render() {
    ...
    let formatValue = valType === 'period' ? this.props.value + 'year' : this.props.value;
    return (
      <div>
      
	      <MDBContainer className="pt-1 mx-0">
	      	<MDBRow> 
	      		<MDBCol className="text-left" lg="6">{this.props.label || this.props.name }</MDBCol>
	      		<MDBCol className="text-right" lg="6">{formatValue}</MDBCol>
	      	</MDBRow>
	      </MDBContainer>
